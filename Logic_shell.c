...
int main(int argc, char * argv[]){
    ...
    char buff[BUFF], directory[BUFF] = "./Commands/Logic/Logic_Commands.txt", *supportedCommands[4]={"Highbit", "DectoBin", "DectoHex", "History"};
	...
	while(1){ 
        ...
        if(strcmp("History", arguments[0]) == 0){
            arguments[i++] = "Logic/Logic_Commands.txt";
        }
        arguments[i] = NULL;
